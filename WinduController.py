...
class Controller(object):
    ...
    def call_method(self, method_name, arg=None):
        ...
        try:
            ...
            print "The controller tries to call method '{}' in 'WinduCore' object,".format(method_name)
    ...
    def get_method(self, method_name, arg=None):
        ...
        try:
            ...
            print "The controller tries to get method '{}' in 'WinduCore' object,".format(method_name)
            print "but " + str(exception_inst) + '\n'
            return None
...
class MockController(object):
    def call_method(self, method_name, arg=None):
        if arg is None:
            print 'WinduCore method {}() called'.format(str(method_name))
        else:
            print 'WinduCore method {}() called with arg = {}'.format(str(method_name), str(arg))
